...
impl ObjectWriter<Primitive, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &Primitive) -> DocumentProcessingResult<()> {
        match *obj {
...
impl ObjectWriter<LensValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &LensValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter LensValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<ExpressionValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &ExpressionValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        match *obj {
            ...
            ExpressionValue::Content(_, _) => Ok(())
...
impl ObjectWriter<ExpressionValue<OutputExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &ExpressionValue<OutputExpression>) -> DocumentProcessingResult<()> {
        match *obj {
            ExpressionValue::Expression(ref e) => self.write_object(w, ctx, e),
            ExpressionValue::Primitive(ref p) => self.write_object(w, ctx, p),
            ExpressionValue::Binding(ref b, _) => self.write_object(w, ctx, b),
            _ => Err(try_process_from_err!(format!("Unsupported output expression: {:?}", obj)))
        }
    }
}

impl ObjectWriter<CommonBindings<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &CommonBindings<ProcessedExpression>) -> DocumentProcessingResult<()> {
        eprintln!("ObjectWriter CommonBindings<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<CommonBindings<OutputExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &CommonBindings<OutputExpression>) -> DocumentProcessingResult<()> {
        eprintln!("ObjectWriter CommonBindings<OutputExpression> (JS): obj: {:?}", obj);

        match *obj {
            CommonBindings::CurrentItem(_) => write!(w, "_item"),
            CommonBindings::CurrentItemIndex => write!(w, "_idx"),
            CommonBindings::CurrentElementValue(_) => write!(w, "_event.target.value"),
            _ => Err(try_eval_from_err!(format!("Unsupported output binding: {:?}", obj)))?
        }?;
...
impl ObjectWriter<ParamValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &ParamValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter ParamValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<PipelineComponentValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &PipelineComponentValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter PipelineComponentValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
fn write_pipeline_head<T: Debug>(_self: &mut DefaultJsWriter, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, head: &ExpressionValue<T>) -> DocumentProcessingResult<()>
...
impl ObjectWriter<PipelineValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &PipelineValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter PipelineValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<FilterValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &FilterValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        eprintln!("ObjectWriter FilterValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<FilterComponentValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &FilterComponentValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        eprintln!("ObjectWriter FilterComponentValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<FilterWhereClause<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &FilterWhereClause<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter FilterWhereClause<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<ReducedPipelineValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &ReducedPipelineValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter ReducedPipelineValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<ReducedPipelineComponent<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &ReducedPipelineComponent<ProcessedExpression>) -> DocumentProcessingResult<()> {
        match *obj {
...
impl ObjectWriter<Expression<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &Expression<ProcessedExpression>) -> DocumentProcessingResult<()> {
        eprintln!("ObjectWriter Expression<ProcessedExpression> (JS): obj: {:?}", obj);
        ...
        match *obj {
            ...
            Expression::BinaryOp(ref op, box ref a, box ref b) => {
                if let BinaryOpType::Add = *op {
                    ...
                    match (a, b) {
                        (&ExpressionValue::Binding(CommonBindings::CurrentReducerState(_), _), _) => {
                            write!(w, "wrap(")?;
                            self.write_object(w, ctx, a)?;
                            write!(w, ").addObject(")?;
                            self.write_object(w, ctx, b)?;
                        ...
                        (&ExpressionValue::Expression(Expression::Composite(CompositeValue::ObjectValue(_))), _) |
                        (_, &ExpressionValue::Expression(Expression::Composite(CompositeValue::ObjectValue(_)))) => {
            ...
            _ => {
                ...
                Err(try_process_from_err!("Unsupported expression in JS writer."))
            }
        }
    }
}
...
impl ObjectWriter<Expression<OutputExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &Expression<OutputExpression>) -> DocumentProcessingResult<()> {
        eprintln!("ObjectWriter Expression<OutputExpression> (JS): obj: {:?}", obj);
        ...
        match *obj {
            ...
            _ => {
                eprintln!("ObjectWriter Expression<OutputExpression> (JS): Unsupported Expression: {:?}", obj);
                Err(try_process_from_err!("Unsupported expression in JS writer."))
            }
...
impl ObjectWriter<QueryCall<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &QueryCall<ProcessedExpression>) -> DocumentProcessingResult<()> {
        let name = obj.name();
...
impl ObjectWriter<QueryParamValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &QueryParamValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        self.write_object(w, ctx, obj.value())
    }
}

fn write_composite<T>(_self: &mut DefaultJsWriter, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &CompositeValue<T>) -> DocumentProcessingResult<()>
    where DefaultJsWriter : ObjectWriter<ExpressionValue<T>, JsOutput> {
        match *obj {
...
impl ObjectWriter<CompositeValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &CompositeValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        write_composite(self, w, ctx, obj)
    }
}

impl ObjectWriter<CompositeValue<OutputExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &CompositeValue<OutputExpression>) -> DocumentProcessingResult<()> {
        write_composite(self, w, ctx, obj)
    }
}

impl ObjectWriter<PathValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &PathValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter PathValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<PathComponentValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &PathComponentValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter PathComponentValue<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<PathValue<OutputExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &PathValue<OutputExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter PathValue<OutputExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<PathComponentValue<OutputExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &PathComponentValue<OutputExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter PathComponentValue<OutputExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<Component<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &Component<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter Component<ProcessedExpression> (JS): obj: {:?}", obj);
...
impl ObjectWriter<Block<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &Block<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter Block<ProcessedExpression> (JS): obj: {:?}", obj);
...
fn write_open<'s>(_self: &'s mut DefaultJsWriter, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, desc: &ElementDescriptor<ProcessedExpression>, is_void: bool) -> DocumentProcessingResult<()> {
    let element_key = ctx.get_element_key()?.map(|s| format!("{}.{}", s, desc.key())).unwrap_or_else(|| desc.key().to_owned());
    ...
    let props: Vec<_> = desc.props().map(|prop| (prop.name().to_owned(), prop.expr().to_owned())).collect();

    let const_props: Vec<_> = props.iter().filter_map(|prop| match prop { _ if prop.1.is_primitive() => Some(prop.to_owned()), _ => None }).collect();
    let eval_props: Vec<_> = props.iter().filter_map(|prop| match prop { _ if !prop.1.is_primitive() => Some(prop.to_owned()), _ => None }).collect();
    ...
    for prop in eval_props {
        ...
        write!(w, ", \"{}\", ", name)?;
        if use_classes { write!(w, "classes(")?; }
        _self.write_object(w, ctx, &expr)?;
        if use_classes { write!(w, ")")?; }
    }
    writeln!(w, ");")?;
...
fn write_comp_desc<'s>(_self: &'s mut DefaultJsWriter, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, comp_desc: &ComponentInstanceDescriptor<ProcessedExpression>, item_key: Option<&str>, is_map: bool) -> DocumentProcessingResult<()> {
    ...
    let key_string = match ctx.environment()? {
        Some(OutputScopeEnvironment::Component) if is_map => format!("props.key + \".{}.\" + _item[0]", component_key),
...
impl ObjectWriter<ElementOp<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &ElementOp<ProcessedExpression>) -> DocumentProcessingResult<()> {
        debug!("ObjectWriter ElementOp<ProcessedExpression> (JS): obj: {:?}", obj);
        ...
        match *obj {
            ...
            ElementOp::StartBlock(_) => {
                Ok(())
            }

            ElementOp::EndBlock(_) => {
                Ok(())
            }

            ElementOp::MapCollection(_, _, _, _) => {
                Ok(())
            }
            ...
            _ => Err(try_eval_from_err!(format!("Cannot write object to JS: {:?}", obj)))
        }
    }
}
...
impl ObjectWriter<ReducerAction<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, action: &ReducerAction<ProcessedExpression>) -> DocumentProcessingResult<()> {
...
impl ObjectWriter<Query<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, query: &Query<ProcessedExpression>) -> DocumentProcessingResult<()> {
        for component in query.components() {
            eprintln!("ObjectWriter QueryComponentValue<ProcessedExpression> (JS): component: {:?}", component);
...
fn write_action_prop_value<'s>(_self: &'s mut DefaultJsWriter, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, expr: &ExpressionValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
...
impl ObjectWriter<ActionOp<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &ActionOp<ProcessedExpression>) -> DocumentProcessingResult<()> {
        match *obj {
            ActionOp::DispatchAction(ref name, ref props, _) |
            ActionOp::DispatchActionTo(ref name, ref props, _, _) => {
                let action = match *obj { ActionOp::DispatchActionTo(_, _, ref target, _) => format!("{}.{}", target.to_uppercase(), name.to_uppercase()), _ => name.to_uppercase() };
...
impl ObjectWriter<RouteActionValue<ProcessedExpression>, JsOutput> for DefaultJsWriter {
    fn write_object(&mut self, w: &mut io::Write, ctx: &mut OutputContext<ProcessedExpression>, obj: &RouteActionValue<ProcessedExpression>) -> DocumentProcessingResult<()> {
        match *obj {
            RouteActionValue::Block(ref block, _) => {
                    self.write_object(w, ctx, block)?;
            }

            RouteActionValue::Actions(Some(ref actions), _) => {
