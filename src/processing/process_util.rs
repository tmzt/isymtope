...
#[inline]
#[allow(dead_code)]
pub fn resolve_reducer_key(processing: &DocumentProcessingState,
...
#[inline]
#[allow(dead_code)]
pub fn map_expr<'input, F: Fn(&ExprValue) -> ExprValue>(expr: &'input ExprValue,
                                                        f: &F)
                                                        -> ExprValue {
    match expr {
