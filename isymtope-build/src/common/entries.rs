...
pub fn must_find_entry<S: ScopeParentId, K, V, F: FnMut(&mut S) -> Option<V>>(scopes: &mut LinkedHashMap<String, S>, scope_id: &str, key: K, mut f: F) -> DocumentProcessingResult<V> where K: Debug + Clone, V: Debug {
